            ...
            <nav class="navbar top-navbar navbar-expand-lg">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a class="" href="index.html">
                            {{-- <img src="../assets/images/.jpg" alt="" class="img-fluid"> --}}
                            <h3 class="fw-bold text-dark text-xl">SI - VOSIS</h3>
                        </a>
                    </div>
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav float-left me-auto ms-3 ps-1">
                        ...
                        <!-- End Notification -->
                        <h4 class=" text-dark mt-3"><span id="tanggalwaktu"></span></h4>
                        <script>
                            var tw = new Date();
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown"
                                ...
                                <img src="../assets/images/logoosis.png" alt="user" class="rounded-circle"
                                    width="40">
